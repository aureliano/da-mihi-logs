...
import com.github.aureliano.evtbridge.output.elasticsearch.jackson.JacksonElasticSearchModule;
...
public class ObjectProcessor {
	...
	public String toJsonString(Object object) {
		try {
			...
			throw new ElasticSearchOutputException(ex, "Failed to convert object to json string");
		}
	...
	public <T> T fromJsonString(String string, Class<T> clazz) {
		try {
			...
			throw new ElasticSearchOutputException(ex, "Failed to convert object from json string");
		}
	}
	...
	public Object getIdValue(Object object) {
		...
		if (idField == null) {
			idField = ReflectionHelper.getIdField(object.getClass(), IndexableId.class);
			if (idField == null) {
				throw new ElasticSearchOutputException("Can't find id field for class: " + object.getClass().getSimpleName());
			}
	...
	public String getRoutingId(Object object) {
		...
		if (indexable == null) {
			throw new ElasticSearchOutputException("Class " + object.getClass().getSimpleName() + " is no Indexable");
		}
