...
import com.github.aureliano.damihilogs.annotation.elasticsearch.DateDetectionEnum;
import com.github.aureliano.damihilogs.annotation.elasticsearch.DocValuesFormatEnum;
import com.github.aureliano.damihilogs.annotation.elasticsearch.DynamicEnum;
import com.github.aureliano.damihilogs.annotation.elasticsearch.FieldDataFormat;
import com.github.aureliano.damihilogs.annotation.elasticsearch.FieldDataLoading;
import com.github.aureliano.damihilogs.annotation.elasticsearch.GeoShapeTreeEnum;
import com.github.aureliano.damihilogs.annotation.elasticsearch.IncludeInAllEnum;
import com.github.aureliano.damihilogs.annotation.elasticsearch.IndexEnum;
import com.github.aureliano.damihilogs.annotation.elasticsearch.IndexOptionsEnum;
...
import com.github.aureliano.damihilogs.annotation.elasticsearch.MultiFieldPathEnum;
import com.github.aureliano.damihilogs.annotation.elasticsearch.NormsEnabledEnum;
import com.github.aureliano.damihilogs.annotation.elasticsearch.NormsLoadingEnum;
import com.github.aureliano.damihilogs.annotation.elasticsearch.NumericDetectionEnum;
import com.github.aureliano.damihilogs.annotation.elasticsearch.ObjectFieldPathEnum;
import com.github.aureliano.damihilogs.annotation.elasticsearch.PostingsFormatEnum;
import com.github.aureliano.damihilogs.annotation.elasticsearch.SimilarityEnum;
import com.github.aureliano.damihilogs.annotation.elasticsearch.TermVectorEnum;
...
public class MappingProcessor {
	...
	public static String getMappingAsJson(Class<?> clazz) {
		...
		if (mappingMap != null) {
			try {
				...
				throw new DaMihiLogsException(ex, "Failed to convert mapping to JSON string");
			}
		}
		return null;
	}
	...
	private static Map<String, Object> getIndexableMap(Class<?> clazz) {
		...
		Indexable indexable = (Indexable) clazz.getAnnotation(Indexable.class);
		if (indexable == null) {
			throw new DaMihiLogsException("Class " + clazz.getName() + " is not Indexable");
		}
		...
		// handle _id
		Field indexableIdField = ReflectionHelper.getIdField(clazz);
	...
	private static void processIndexableProperty(AccessibleObject accessibleObject, Map<String, Object> propertiesMap) {
		...
		if (indexableProperty == null) {
			throw new DaMihiLogsException("Unable to find annotation IndexableProperty");
		}
		...
		if (fieldName == null) {
			throw new DaMihiLogsException("Unable to find field name");
		}
	...
	private static void processIndexableComponent(AccessibleObject accessibleObject, Map<String, Object> propertiesMap) {
		...
		if (indexableComponent == null) {
			throw new DaMihiLogsException("Unable to find annotation IndexableComponent");
		}
		String fieldName = null;
		if (accessibleObject instanceof Field) {
			fieldName = ((Field) accessibleObject).getName();
		...
		if (fieldName == null) {
			throw new DaMihiLogsException("Unable to find field name for IndexableComponent");
		}
	...
	private static Map<String, Object> getIndexableComponentMapping(AccessibleObject accessibleObject, IndexableComponent indexableComponent) {
		...
		if (fieldClazz == null) {
			throw new DaMihiLogsException("Unknown AccessibleObject type");
		}
	...
	private static void processIndexableProperties(AccessibleObject accessibleObject, Map<String, Object> propertiesMap) {
		...
		if (indexableProperties == null) {
			throw new DaMihiLogsException("Unable to find annotation IndexableProperties");
		}
		if (indexableProperties.properties().length < 1) {
			throw new DaMihiLogsException("IndexableProperties must have at lease one IndexableProperty");
		}
		...
		if (fieldName == null) {
			throw new DaMihiLogsException("Unable to find field name for IndexableProperties");
		}
		...
		for (IndexableProperty property : indexableProperties.properties()) {
			...
			if (propertyName.isEmpty()) {
				if (!emptyNameProcessed) {
					...
					throw new DaMihiLogsException("Field name cannot be empty in multi-field");
				}
			}
