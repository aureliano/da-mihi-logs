...
public class InputConfigConverter implements IConfigurationConverter<IConfigInput> {
	...
	public IConfigInput convert(Map<String, Object> data) {
		...
		if ("file".equals(type)) {
			return this.createFileConfig(this._getAsHash(map, "properties"));
		} else if ("externalCommand".equals(type)) {
			return this.createExternalCommandConfig(this._getAsHash(map, "properties"));
		} else if ("standard".equals(type)) {
			return this.createStandardConfig(this._getAsHash(map, "properties"));
		} else if ("url".equals(type)) {
			return this.createUrlConfig(this._getAsHash(map, "properties"));
		} else {
